# Topical Map Engine — v1

A Python engine that generates Koray-style semantic topical maps from a seed keyword and 8 intake answers. Built on Anthropic alone (no external SEO APIs in v1).
